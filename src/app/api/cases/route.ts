      ...
      data: {
        ...
        checklistItems: {
          create: [
            ...
            { label: "Generate itemized statement", sortOrder: 4, blocksExport: true },
            { label: "Generate notice letter", sortOrder: 5, blocksExport: true },
            { label: "Send to tenant(s)", sortOrder: 6 },
